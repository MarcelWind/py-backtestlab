...
def split_events_in_sample_out_of_sample(
    ...
    *,
    ...
    return EventPartition(
        ...
        n_events_in_sample=insample_count,
        n_events_out_of_sample=outsample_count,
        in_sample_ratio=float(insample_count / len(event_slugs)),
        out_of_sample_ratio=float(outsample_count / len(event_slugs)),
